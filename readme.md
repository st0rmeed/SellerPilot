...
> _Проект выполнен в рамках коммерческого freelance-заказа. За 1.5 месяца поддержки потребовалось ~5 крупных обновлений из-за постоянных изменений DOM на стороне Seller Pilot и доработки функционала. Планировался вывод продукта в production и монетизация, но инициатива была пресечена_
